						...
						<van-collapse-item :name="index">
							...
							<div v-show="showList">
								<van-cell is-link v-for="(list,index) in Treedata_r" :key="index" :id="list.ID" @click="TreedataR($event,list.ID,index,list.NAME)">
									<img src="../../assets/images/user_icon/icon_g@2x (4).png" alt="" width='12' :id="list.ID" v-if="list.NAME=='桥涵专业'" @click="TreedataR($event,list.ID,index,list.NAME)">
									<img src="../../assets/images/user_icon/icon_g@2x (2).png" alt="" width='12' :id="list.ID" v-if="list.NAME=='轨道专业'" @click="TreedataR($event,list.ID,index,list.NAME)">
									<img src="../../assets/images/user_icon/icon_g@2x (1).png" alt="" width='12' :id="list.ID" v-if="list.NAME=='路基专业'" @click="TreedataR($event,list.ID,index,list.NAME)">
									&nbsp;&nbsp;{{list.NAME}}
									<span style="color: #aaa;float: right;":id="list.ID" @click="TreedataR($event,list.ID,index,list.NAME)">已完成</span>
									<span style="color: #69966F;float: right;":id="list.ID" @click="TreedataR($event,list.ID,index,list.NAME)">22% </span>
								</van-cell>

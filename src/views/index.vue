	...
	<div id="index">
		...
		<div class="containerIndex">
			...
			<ul class="navList">
				...
				<li @click="tost()"><img src="../assets/images/index_icon/icon_dw@2x.png" alt=""><p>人机定位</p></li>
				<li @click="tost()"><img src="../assets/images/index_icon/icon_jk@2x.png" alt=""><p>智能监控</p></li>

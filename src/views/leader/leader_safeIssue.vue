  ...
  <div class="container">
    ...
    <div class="list-content">
      ...
      <div
        ...
        style="text-align: center;background: #ececec;line-height: 36px;color:#000;font-size: 16px;"
      >暂无数据
      </div>
      <ul class="l-list">
        <li
  ...
  export default {
    ...
    methods: {
      ...
      getStatus(sate, id) {
        ...
        // if (sate == 2) {
        //   this.$router.push({
        //     path: "/problemX?userId=" + this.$route.query.userId + "&id=" + id
        //   });
        // }
        // if (sate == 3) {
        //   this.$router.push({
        //     path:
        //       "/LeaderProblemS?userId=" + this.$route.query.userId + "&id=" + id
        //   });
        // }
        // if (sate == 5) {
        //   this.$router.push({
        //     path:
        //       "/LeaderProblemW?userId=" + this.$route.query.userId + "&id=" + id
        //   });
        // }
        ...
        //   this.$router.push({
        //     path:
        //       "/LeaderProblemY?userId=" + this.$route.query.userId + "&id=" + id
        //   });
        // }
      },
      selectSafetyListS() {
...
<style scoped>
  * {
  ...
  .van-dropdown-menu .van-dropdown-menu__item:first-child {
